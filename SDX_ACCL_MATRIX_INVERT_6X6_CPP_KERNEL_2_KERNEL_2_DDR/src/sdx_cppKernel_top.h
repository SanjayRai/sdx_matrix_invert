...
#define ZERO_f 1.0e-32

#define data_t float
#define DIM 6UL
#define NUMBER_OF_ELEMENTS_PER_KERNEL_OPERATION (DIM*DIM)
#define NUMBER_OF_SDX_BUS_XFERS_PER_INPUT 3UL
#define NUMBER_OF_SDX_BUS_XFERS_PER_OUTPUT 3UL
#define NUM_CU 2
...
//#define NUMBER_OF_DATA_SETS 4UL
//#define NUMBER_OF_DATA_SETS 16UL
//#define NUMBER_OF_DATA_SETS 64UL
//#define NUMBER_OF_DATA_SETS 1024UL
#define NUMBER_OF_DATA_SETS 1024*256
//#define NUMBER_OF_DATA_SETS 1024UL*1024UL
//#define NUMBER_OF_DATA_SETS 1024UL*2UL
...
const long int HLS_KERNEL_WRAPPER_II=(long int)NUMBER_OF_SDX_BUS_XFERS_PER_OUTPUT;
